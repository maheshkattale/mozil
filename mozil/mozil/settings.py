"""
Django settings for mozil project.
...
SECRET_KEY = 'django-insecure-q@+t3py&pg#x(qu-uz&s%ylfc)@o$s%1y5vvgqoo%k0y3cdh#1'
...
WSGI_APPLICATION = 'mozil.wsgi.application'
